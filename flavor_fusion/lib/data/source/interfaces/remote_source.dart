...
abstract class IRemoteSource {
  ...
  Future<Either<Map<String,dynamic>, Exception>> searchRecipes(String search,
      List<String> ingredients, MealType mealType, SkillLevel skillLevel,String? endCursor);
}
